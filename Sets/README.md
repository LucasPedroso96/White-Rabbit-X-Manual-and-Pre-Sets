...
|---|---|---|---:|
| `01_SLTP` | SL + TP as ATR multiples | Stop, Take, Breakeven on/off, BE distance | 8.01e+20 |
| `02_SLTP_ORGANIC` | SL + organic TP (anchored to the last trade) | Stop, Take, Breakeven on/off, BE distance | 8.01e+20 |
| `03_TRAIL_ONLY` | SL + trailing, no TP: lets it run | Stop, trailing source, Trail, BE | 2.00e+20 |
...
| `07_GRID_SEPARATE` | Grid, one target per side | Take, Multiplier, MinimumDistance, number of legs | 8.01e+19 |
| `08_GRID_UNIFIED` | Grid, single basket target, both sides open | Take, Multiplier, MinimumDistance, legs per side | 1.60e+20 |
