...
| `07_GRID_SEPARATE` | Grid, one target per side | Take, Multiplier, MinimumDistance, number of legs | 9.61e+20 |
| `08_GRID_UNIFIED` | Grid, single basket target, both sides open | Take, Multiplier, MinimumDistance, legs per side | 1.92e+21 |
