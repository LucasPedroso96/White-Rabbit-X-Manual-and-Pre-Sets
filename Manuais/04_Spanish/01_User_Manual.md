...
## Motores de señal y métodos de entrada

Los seis motores comparten reversión, cruce signal/reference y baseline/reference. And exige la misma vela cerrada; All admite cualquiera.

- Doce motores nativos: MACD, EMA Cross, Momentum, Stochastic, TRIX, RSI, CCI, Williams %R, DeMarker, MFI, OsMA e Ichimoku.
- Siete métodos con semántica AND/OR explícita en vela cerrada.
- Filtros MTF, MA, ADX, ATR y noticias independientes.
- Cuatro PositionSizeMode y protecciones equity/margin.
- Stop, take, breakeven, trailing y reversión forman la salida.
- Dashboard, horario, idiomas y WFO completan el sistema.
...
MTF es una alineación MACD superior; MA, ADX, volatilidad ATR y noticias son independientes. Más filtros reducen la muestra.
...
Spread, margen, paso de volumen, tick size y límites stops/freeze condicionan la ejecución. Confirme el resultado en el Journal.
...
Stop, take ATR, breakeven, trailing ATR y reversión son controles separados. ReversalExitUseEntryFilters decide si los filtros confirman la salida.

## Riesgo y recuperación

Seleccione un PositionSizeMode. Percentage y Fixed-R requieren stop. Grid, Martingale y D'Alembert son modos de recuperación de investigación.

## Horario, interfaz y WFO

El horario usa el servidor del bróker, cruza medianoche y controla Saturday/Sunday. WFO define IS/OOS y criterio.
...
La tabla sigue la declaración de la fuente. Los separadores se conservan en el esquema .set.
