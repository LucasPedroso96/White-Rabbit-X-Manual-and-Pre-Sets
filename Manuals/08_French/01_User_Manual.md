...
Six moteurs partagent retournement, croisement signal/référence et base/référence. And exige la même bougie clôturée ; All accepte tout événement.
...
MTF est un alignement MACD supérieur ; MA, ADX, volatilité ATR et news sont indépendants.
...
Spread, marge, pas de volume, tick size et limites stops/freeze influencent l'ordre. Vérifiez le Journal.
...
Stop, take ATR, breakeven, trailing ATR et reversal exit sont séparés. ReversalExitUseEntryFilters contrôle les filtres de sortie.

## Risque et récupération

Choisissez un PositionSizeMode. Percentage/Fixed-R exigent stop. Grid, Martingale et D'Alembert sont des modes de recherche.

## Horaire, interface et WFO

Heure serveur du courtier, intervalle nocturne et Saturday/Sunday sont gérés. WFO définit IS/OOS.
...
## Référence complète des inputs

Le tableau suit la source. Les chaînes séparatrices appartiennent au schéma .set.
