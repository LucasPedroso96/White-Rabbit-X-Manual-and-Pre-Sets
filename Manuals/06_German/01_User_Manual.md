# White Rabbit X — Vollständiges Handbuch
...
## Signale und Einstiege

Sechs Engines nutzen Reversal, Signal/Referenz- und Basis/Referenz-Cross. And gilt auf derselben geschlossenen Kerze; All akzeptiert jedes Ereignis.
...
MTF ist eine MACD-Ausrichtung höherer Zeitrahmen; MA, ADX, ATR-Volatilität und News sind unabhängig.
...
Spread, Margin, Volume Step, Tick Size sowie Stops-/Freeze-Grenzen beeinflussen Orders. Ergebnis im Journal prüfen.
...
Stop, ATR-Take, Breakeven, ATR-Trailing und Reversal Exit sind getrennt. ReversalExitUseEntryFilters steuert Exit-Filter.

## Risiko und Recovery

Nur einen PositionSizeMode wählen. Percentage/Fixed-R benötigen Stop. Grid, Martingale und D'Alembert sind Forschung.

## Zeitplan, Oberfläche und WFO

Broker-Serverzeit, Intervalle über Mitternacht und Saturday/Sunday werden unterstützt. WFO definiert IS/OOS.
...
## Vollständige Input-Referenz

Die Tabelle folgt der Quellreihenfolge. Trennstrings gehören zum .set-Schema.
