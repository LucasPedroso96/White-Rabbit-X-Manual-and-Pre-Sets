...
- **Autobot**: автоматизация, лежащая в основе этой библиотеки, опубликована в том же репозитории — это код, который реально генерирует, тестирует в режиме walk-forward, проверяет по Monte Carlo и подтверждает на реальных тиках каждый набор перед публикацией. Запустите его сами против своего брокера и своих инструментов или прочитайте код, чтобы увидеть, как набор заслужил свой статус.
...
Дополнительный продукт: **Historical Tool Manager** (MQL5 Market: https://www.mql5.com/pt/market/product/188711) импортирует глубокую историю тиков и M1 в MT5 в виде Custom Symbols — источник данных, от которого зависит этап подтверждения на реальных тиках в Autobot.
