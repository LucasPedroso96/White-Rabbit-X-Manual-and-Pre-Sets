...
lines = [
    ...
    "",
    f"**{len(rows)} sets** = 89 symbols x 11 systems x 2 indicator variants x the "
...
DESC = {
    ...
    "08_GRID_UNIFIED": ("Grid, single basket target, both sides open",
                        "Take, Multiplier, MinimumDistance, legs per side"),
